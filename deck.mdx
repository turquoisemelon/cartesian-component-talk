...
<Notes>
  ...
  Design kit: assets for designers to use when creating screens/pages for an application/product.
  Component library is where you have all your component code aka building blocks of your application.
  Developer Sandbox is used to display, test and validate your components in isolation with their different variations without having to run the application.
...
---
## Cartesian Product of Component Props
...
* [Cartesian product of multiple arrays](https://stackoverflow.com/questions/12303989/cartesian-product-of-multiple-arrays-in-javascript)
